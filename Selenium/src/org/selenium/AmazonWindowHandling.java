...
public class AmazonWindowHandling {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		File destination = new File("D:\\New folder\\iphoneCart.png");
		...
		File destination1 = new File("D:\\\\New folder\\\\iphoneCart2.png");
		...
		File destination2 = new File("D:\\\\New folder\\\\iphoneCart3.png");
		...
		File destination3 = new File("D:\\\\New folder\\\\iphoneCart4.png");
		...
		File destination4 = new File("D:\\\\New folder\\\\iphoneCart5.png");
